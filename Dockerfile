...
# Using Debian slim for better canvas compatibility

# Stage 1: Build stage
FROM node:20-slim AS builder

# Install build dependencies for canvas and TypeScript
